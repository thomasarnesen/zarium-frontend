        ...
        <div className="container mx-auto px-6">
          ...
          <div className="pt-24 pb-20">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg text-emerald-700 dark:text-emerald-300 mb-10 leading-relaxed max-w-2xl mx-auto">
                Transform your ideas into professional Excel spreadsheets in seconds.
                Just describe what you need or upload an existing file, and our AI will create
                complete spreadsheets with advanced formulas, 3D graphs, and diagrams.
              </p>
          ...
          <div className="bg-emerald-700 dark:bg-emerald-800 text-white -mx-6 px-6 py-16 mb-12 rounded-xl">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <button
                onClick={handleGetStarted}
                className="px-8 py-3 rounded-lg text-base font-medium bg-white text-emerald-800 hover:bg-emerald-100 transition-all shadow-md hover:shadow-lg"
              >
